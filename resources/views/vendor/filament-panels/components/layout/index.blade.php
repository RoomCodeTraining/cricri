...
<x-filament-panels::layout.base :livewire="$livewire">
    <div class="flex w-full min-h-screen fi-layout overflow-x-clip">
        @if (filament()->hasNavigation())
            <div
                ...
                class="fixed inset-0 z-30 transition duration-500 fi-sidebar-close-overlay bg-gray-950/50 lg:hidden"
            ></div>
